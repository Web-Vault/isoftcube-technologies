...
export default function AboutPage() {
  ...
  if (loading || !about) {
    return (
      <div className="min-h-screen flex items-center bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 justify-center text-xl text-white">
        Loading...
      </div>
    );
  }
  ...
  const pageKeywords =
    "Isoftcube, about, company, team, mission, vision, values, technology, software, web development, app development, digital transformation, innovation";
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content={siteName || "Isoftcube Technologies"}
        />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            founder: [{ "@type": "Person", name: "Bhavesh Kumbhani" }],
          }),
        }}
      />
