...
export default function HomePage() {
              ...
              return (
                <div className="bg-gradient-to-br from-white/70 via-blue-50/60 to-purple-50/60 rounded-2xl shadow border border-blue-100/30 px-4 pt-10 pb-6 w-full flex flex-col items-center relative min-h-[320px] max-w-xs">
                  <img
                    ...
                    style={{ zIndex: 20 }}
                  />
                  <div className="mt-8 text-center text-base font-medium text-gray-700 line-clamp-3">
                    {prevReview.text}
                  </div>
                  <div className="mt-4 text-sm text-gray-500">
                    {prevReview.reviewer_name}
                  </div>
                </div>
              );
            })()}
          ...
          <div className="relative flex-1 flex flex-col items-center z-10">
            ...
            <div
              ...
              style={{
                ...
                maxWidth: 480,
                boxShadow:
                  "0 8px 32px 0 rgba(59,130,246,0.10), 0 1.5px 0 0 #a5b4fc",
              }}
            >
              {/* Floating avatar */}
                ...
                <Badge className="mt-2 px-3 py-1 bg-blue-100 text-blue-700 border-0 font-medium flex items-center gap-1 shadow-sm z-20">
                  ...
                  >
                    <g>
                      <path
                        fill="#4285F4"
                        d="M43.611 20.083H42V20H24v8h11.303C33.973 32.833 29.418 36 24 36c-6.627 0-12-5.373-12-12s5.373-12 12-12c2.69 0 5.166.896 7.163 2.393l6.084-6.084C33.684 6.053 28.994 4 24 4 12.954 4 4 12.954 4 24s8.954 20 20 20c11.045 0 19.824-8.955 19.824-20 0-1.341-.138-2.651-.213-3.917z"
                      />
                      <path
                        fill="#34A853"
                        d="M6.306 14.691l6.571 4.819C14.655 16.104 19.001 13 24 13c2.69 0 5.166.896 7.163 2.393l6.084-6.084C33.684 6.053 28.994 4 24 4c-7.732 0-14.41 4.388-17.694 10.691z"
                      />
                      <path
                        fill="#FBBC05"
                        d="M24 44c5.356 0 10.065-1.797 13.82-4.889l-6.383-5.238C29.418 36 24 36 24 36c-5.408 0-9.963-3.167-11.303-8.083l-6.571 5.081C9.59 39.612 16.268 44 24 44z"
                      />
                      <path
                        fill="#EA4335"
                        d="M43.611 20.083H42V20H24v8h11.303c-1.13 3.833-5.685 8-11.303 8-5.408 0-9.963-3.167-11.303-8.083l-6.571 5.081C9.59 39.612 16.268 44 24 44c7.732 0 14.41-4.388 17.694-10.691z"
                      />
                    </g>
                  </svg>
                  Google Review
              ...
              <div className="relative w-full flex flex-col items-center min-h-[120px] max-h-44 mt-8 mb-6">
                <Quote
                  className="absolute top-0 left-1/2 -translate-x-1/2 text-blue-100 opacity-40 z-0"
                  size={64}
                />
                <p
                  className="text-gray-800 text-base text-sm font-medium italic text-center px-2 z-10 w-full transition-all duration-300 relative"
                  style={{
                    maxHeight: "140px",
                    overflow: "hidden",
                    display: "-webkit-box",
  ...
  return (
    <>
      <Head>
        <title>
          Isoftcube Technologies | Digital Excellence, Web & Mobile Solutions
        </title>
        <meta
          name="description"
          content="Isoftcube Technologies builds digital excellence through innovative web and mobile solutions. Transform your ideas into powerful products with our expert team."
        />
        <meta
          name="keywords"
          content="Isoftcube, web development, mobile app development, digital solutions, software company, innovation, technology, IT services, custom software, UI/UX design, cloud solutions"
        />
        ...
        <meta
          property="og:title"
          content="Isoftcube Technologies | Digital Excellence, Web & Mobile Solutions"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="https://isoftcube.com/og-image.jpg"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              founders: [{ "@type": "Person", name: "Bhavesh Kumbhani" }],
              numberOfEmployees: {
              ...
              address: {
                "@type": "PostalAddress",
                streetAddress:
                  "717, Shivalik Satyamev, Nr. Vakil Saheb Bridge, S.P. Ring Road, South Bopal, Bopal",
              ...
              description:
                "Isoftcube Technologies builds digital excellence through innovative web and mobile solutions. Transform your ideas into powerful products with our expert team.",
            }),
          }}
        />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              potentialAction: {
                "@type": "SearchAction",
                target:
                  "https://isoftcube-technologies.onrender.com/search?q={search_term_string}",
        ...
        <section className="py-24 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-7xl px-6">
            <div className="text-center mb-20">
              <Badge className="mb-4 px-4 py-2 bg-blue-100 text-blue-800 border-0 font-medium">
                Our Expertise
              </Badge>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-xl text-gray-300 leading-relaxed">
                    Our team combines technical expertise with strategic vision
                    to deliver solutions that not only work flawlessly but drive
                ...
                <div className="space-y-6">
                  {[
                    ...
                    },
                    {
                      ...
                      description:
                        "Every project is measured by real business impact and measurable success metrics.",
                      icon: Award,
                    },
                    {
                    ...
                    {[
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          <div
                            className={`w-3 h-3 bg-${item.color}-400 rounded-full animate-pulse`}
                          ></div>
        ...
        <section className="py-24 bg-gradient-to-b from-white to-blue-50 relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-7xl px-6">
            <div className="text-center mb-16">
              <Badge className="mb-4 px-4 py-2 bg-yellow-100 text-yellow-800 border-0 font-medium">
                Testimonials
              </Badge>
