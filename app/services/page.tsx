...
export default function ServicesPage() {
  ...
  return (
    <>
      <Head>
        <title>
          Our Services | Isoftcube Technologies - Web, App, Cloud & Digital
          Solutions
        </title>
        <meta
          name="description"
          content="Explore Isoftcube Technologies' full range of services: web development, mobile app development, cloud solutions, IoT, cybersecurity, and more. Empower your business with innovative digital solutions tailored to your needs."
        />
        <meta
          name="keywords"
          content="Isoftcube, services, web development, mobile app development, cloud solutions, IoT, cybersecurity, IT consulting, digital transformation, software company, technology, innovation"
        />
        ...
        <meta
          property="og:title"
          content="Our Services | Isoftcube Technologies - Web, App, Cloud & Digital Solutions"
        />
        <meta
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Explore the full range of digital, web, app, cloud, and IT services offered by Isoftcube Technologies.",
            ...
            itemListElement: services.map((service, index) => ({
              ...
              name: service.title,
              description:
                service.shortDescription || service.description || undefined,
            })),
          }),
        }}
      />
      <main className="min-h-screen bg-white dark:bg-slate-950">
            ...
            <div className="mt-14">
              <div className="space-y-6">
                ...
                <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed font-light">
                  From web and app development to cloud, IoT, and cybersecurity,
                  our expert team delivers innovative IT solutions tailored to
                  your business needs. Explore how we can help you thrive in the
                  digital era.
                </p>
              </div>
            </div>
        ...
        <section className="relative w-full bg-gradient-to-br from-cyan-50 via-blue-50 to-purple-100 dark:from-slate-900 dark:via-slate-950 dark:to-blue-950 py-20 px-4 mt-24 border-t border-blue-100 dark:border-slate-800">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-blue-900 dark:text-cyan-200 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left mt-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-blue-900 dark:text-cyan-100 mb-1">
                    Collaborative Process
                  </h3>
                  <p className="text-gray-700 dark:text-slate-300">
                    We work closely with you at every step, ensuring your vision
                    is realized and your goals are met.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-slate-300">
                    Our team leverages the latest technologies and creative
                    thinking to deliver future-ready solutions.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-slate-300">
                    We maintain the highest standards and keep you informed
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-slate-300">
                    We focus on delivering measurable impact and long-term value
                    for your business.
                  </p>
                </div>
              </div>
