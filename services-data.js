export const services = [
  {
    ...
    subServices: [
      ...
      },
      {
        ...
        description:
          "Complete web solutions combining frontend and backend expertise",
        technologies: [
          "MERN Stack",
          "MEAN Stack",
          "Next.js",
      ...
      },
      {
        ...
        description:
          "Custom content management systems and headless CMS solutions",
        technologies: [
          "WordPress",
          "Drupal",
          "Strapi",
    ...
    subServices: [
      {
        ...
        description:
          "Native iOS applications with optimal performance and user experience",
        technologies: [
          "Swift",
          "SwiftUI",
          "Objective-C",
      ...
      },
      {
        ...
        description:
          "Native Android applications following Material Design principles",
        technologies: [
          "Kotlin",
          "Java",
          "Android Studio",
      ...
      },
      {
        ...
        description:
          "Single codebase applications for both iOS and Android platforms",
        technologies: [
          "React Native",
          "Flutter",
          "Expo",
    ...
    subServices: [
      {
        ...
        description:
          "Intelligent home automation systems for comfort and security",
        technologies: [
          "Raspberry Pi",
          "Arduino",
          "Zigbee",
      ...
      },
      {
        name: "Industrial IoT",
        description:
          "Industrial automation and monitoring solutions for manufacturing",
        technologies: [
          "PLC",
          "SCADA",
          "Modbus",
  ...
  },
  {
    ...
    subServices: [
      ...
      },
      {
        name: "AWS Solutions",
        description:
          "Comprehensive Amazon Web Services implementation and management",
        technologies: [
          "EC2",
          "S3",
          "RDS",
    ...
    subServices: [
      {
        ...
        description:
          "Strategic planning and roadmap development for digital transformation",
        technologies: [
          "Business analysis",
  ...
  },
  {
    ...
    subServices: [
      ...
      },
      {
        ...
        description:
          "Text analysis, chatbots, and language understanding systems",
        technologies: [
          "OpenAI GPT",
          "BERT",
          "spaCy",
  ...
  },
  {
    ...
    icon: "Globe",
    shortDescription:
      "Complete e-commerce platforms and online store development",
    fullDescription:
  ...
  // ... (repeat for all other services, converting icon to string)
];
